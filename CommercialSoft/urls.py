...
urlpatterns=[
    ...
    path('vente/recherche/vente/categorie', views.recherche_vente_categorie,name="rechercheVenteCategorie"),
    path('vente/categorie', views.vente_par_categorie, name="commerce_venteParCategorie"),
    ...
    path('pdf/facture/demande/<int:demande_id>/', views.pdf_facture_proforma_demande, name='pdf_facture_proforma_demande'),
    ...
    path('importer/entreprise', views.import_entreprise_view, name="importEntreprise"),
